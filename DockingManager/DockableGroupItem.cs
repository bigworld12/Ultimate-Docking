...
{
   public class DockableGroupItem:TabItem
   {
      static DockableGroupItem()
      {
         DefaultStyleKeyProperty.OverrideMetadata(typeof(DockableGroupItem),
            new FrameworkPropertyMetadata(typeof(DockableGroupItem)));
      }

      public DockableGroupItem()
        {
        ...
        public static readonly DependencyProperty CloseButtonEnabledProperty =
            DependencyProperty.Register("CloseButtonEnabled", typeof(bool), typeof(DockableGroupItem), new PropertyMetadata(false, OnCloseButtonEnabledPropertyChangedCallback));
        ...
        {
           var item = dependencyObject as DockableGroupItem;
            if (item != null)
            {
        ...
        void closeButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var owningTabControl = this.TryFindParent<DockableGroup>();
            ...
            owningTabControl.InternalCloseTabCommand.Execute(new Tuple<object, DockableGroupItem>(data, this));
        }
        ...
        public static readonly DependencyProperty CloseTabCommandProperty = DependencyProperty.Register("CloseTabCommand", typeof(ICommand), typeof(DockableGroupItem));
        ...
        public static readonly DependencyProperty CloseTabCommandParameterProperty =
            DependencyProperty.Register("CloseTabCommandParameter", typeof(object), typeof(DockableGroupItem), new PropertyMetadata(null));
